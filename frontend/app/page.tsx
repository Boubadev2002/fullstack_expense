    ...
    const getTransactions = async() => {
     ...
     const deleteTransactions = async(id: string) => {
        try {
            ...
            toast.success("Transaction supprimée.")
             ...
             toast.error("Erreur de supression de la transaction.")
        }
    }
     ...
     const addTransactions = async() => {
       if(!text || amount === "" || isNaN(Number(amount))){
          toast.error("Merci de remplir le texte et un montant valide.")
            return
       }
     setLoading(true)
        try{
            ...
            setText("")
            setAmount("")
            toast.success("Transaction ajoutée avec succés.")
        }catch (error){
...
<button className="btn btn-warning"
    ...
    Ajouter une transaction
      ...
      <div className="rounded-2x1 border-2 border-warning/10 border-dashed bg-warning/5">
